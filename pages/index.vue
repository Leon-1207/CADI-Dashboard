      ...
      <div class="dashboard">
        ...
        <div class="box small-box">
          ...
          <div class="box-footer">
            <button class="link" id="show-new-customers-button" style="float: right">
        ...
        <div class="box small-box">
          ...
          <div class="box-footer">
            <button class="link" id="show-all-customers-button" style="float: right">
              Details <i class="fas fa-arrow-right"></i>
            </button>
          </div>
        </div>

        <div id="new-customers-box" class="box box-closed toggle-box" style="height: 0">
          <span class="title">
            <span>Neue Anmeldungen</span>
            <div class="icon">
              <i class="fas fa-user-plus"></i>
          ...
          <div class="box-footer">
            <button id="hide-new-customers-button" class="link" style="float: right">
              Schließen
            </button>
          </div>
        </div>

        <div id="all-customers-box" class="box box-closed toggle-box" style="height: 0">
          <span class="title">
            <span>Bisher angemeldet und bestätigt</span>
            <div class="icon">
              <i class="fas fa-users"></i>
          ...
          <p>Tim Tester</p>
          <div class="box-footer">
            <button id="hide-all-customers-button" class="link" style="float: right">
              Schließen
            </button>
          </div>
        </div>
        ...
        <div class="box">
          <p>
            ...
            gubergren, no sea <a href="">takimata sanctus</a> est Lorem ipsum dolor sit
            amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
            <a href="">nonumy eirmod tempor invidunt</a> ut labore et dolore magna
...
export default {
  ...
  methods: {
      ...
      headers.forEach(function (header) {
        header.addEventListener("click", function () {
          ...
          headers.forEach(function (header) {
            ...
            icons.forEach(
              (iconStr) => (textWithoutIcons = textWithoutIcons.replace(iconStr, ""))
            );
    ...
    toggleDashboardBoxesJS() {
      ...
      const newCustomersBox = window.document.getElementById("new-customers-box");
      ...
      const allCustomersBox = window.document.getElementById("all-customers-box");
