...
export default {
  ...
  methods: {
    tableJS() {
      ...
      const popupOverlay = window.document.querySelector('.popup-overlay')
      const popupContent = window.document.querySelector('.popup-content')
      ...
      tbody.addEventListener('click', function (event) {
        ...
        if (target) {
          ...
          window.document.addEventListener('click', closePopup)
        }
      })
      ...
      function closePopup(event) {
        if (
          ...
          window.document.removeEventListener('click', closePopup)
        }
      }
    },
